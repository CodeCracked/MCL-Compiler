...
public class MCLFunctionCallError extends MCLError
{
    ...
    {
        super(compiler.getSource().getCodeLocation(call.startPosition()), compiler.getSource().getCodeLocation(call.endPosition()), "Invalid Function Arguments", buildDetails(compiler, call, function));
    }
    ...
    private static String buildDetails(MCLCompiler compiler, FunctionCallNode call, FunctionSymbol function)
    {
        ...
        {
            builder.append(function.parameters.get(i).getMinecraftName());
