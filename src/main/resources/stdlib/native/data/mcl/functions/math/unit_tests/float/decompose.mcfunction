#> mcl:math/unit_tests/float/decompose
...
execute store result storage u_test copy int 1 run scoreboard players get R0 mcl.math.io
data modify storage u_test actual append from storage u_test copy

execute store result storage u_test copy int 1 run scoreboard players get R1 mcl.math.io
data modify storage u_test actual append from storage u_test copy

execute store result storage u_test copy int 1 run scoreboard players get R2 mcl.math.io
data modify storage u_test actual append from storage u_test copy
