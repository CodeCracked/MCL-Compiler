#> mcl:math/float/32/multiply/main
...
execute if score 8 mcl.math.temp matches 1 run function mcl:math/float/32/multiply/exception/nan
execute if score 8 mcl.math.temp matches 0 run function mcl:math/float/32/multiply/branch0
